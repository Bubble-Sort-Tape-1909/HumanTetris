...
//     this.tempLeftAnkleY = null
//     this.startingX = null

//     //Initialize start key point x & y:
//     this.keyPointsToCollide = {
//       nose: {x: 0, y: 0},
//       leftEye: {x: 0, y: 0},
//       rightEye: {x: 0, y: 0},
//       leftEar: {x: 0, y: 0},
...
//     this.gameCounter = 0
//     this.isClearGlobal = false

//     // getting random window shape
//     this.currentWindowShape = null
//     this.windowShapesName = [
//       'split',
//       'tShape',
//       'figureSkater',
//       'jerrysHole',
...
//   getRandomWindowShapeName = windowShapesName => {
...
//   windowShapeConstructor = (startingX, tempLeftAnkleY, tempScale, name) => {
//     this.poly = ['hi']
//     if (name === 'split') {
//       return [
...
//   score = () => {
//     if (this.selectedWindowName === 'tShape') {
//       playersScore += 100
//     } else if (this.selectedWindowName === 'split') {
//       playersScore += 150
//     } else if (this.selectedWindowName === 'figureSkater') {
//       playersScore += 200
//     } else if (this.selectedWindowName === 'jumpingJack') {
//       playersScore += 150
//     } else if (this.selectedWindowName === 'runningMan') {
//       playersScore += 150
//     } else if (this.selectedWindowName === 'jerrysHole') {
//       playersScore += 90
//     } else if (this.selectedWindowName === 'breakDancer') {
//       playersScore += 500
//     }
...
//       canvasContext.clearRect(1920, 1080, videoWidth, videoHeight)
